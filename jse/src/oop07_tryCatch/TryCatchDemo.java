...
/*
 예외는 프로그램 개발시 바생하는 에러와 다른 현상
 프로그램 개발시 발생하는 에러에 대한 대처는 필수 
 안정적으로 컴파일 후 운영중에 바랭하는 에러에 대부분은 예외
...
public class TryCatchDemo { // 자동완성 지양.
	public static void main(String[] args) {
		int a=5, b=0;
		int mok=0, nmg = 0;
		//try{}catch(Exception ex){} 미리 틀 잡는게 좋음.
		try{
			mok = a/b;
			nmg = a%b;
		}catch(Exception ex){
			ex.printStackTrace(); //java.lang 패키지 내에 있음. 
